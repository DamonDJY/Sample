...
To update the database use this command from the Web project folder (replace `DamonPros.Sample` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../DamonPros.Sample.Infrastructure/DamonPros.Sample.Infrastructure.csproj -s DamonPros.Sample.Web.csproj
```
